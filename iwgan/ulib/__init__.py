...
def param(name, *args, **kwargs):
    ...
    Creates and returns shared `tf.Variable`,
    ...
    if name not in _params:
        # This code has some questions, and
        kwargs['name'] = name
        param_local = tf.Variable(*args, **kwargs)
        param_local.param = True
        _params[name] = param_local
    result = _params[name]
    i = 0
